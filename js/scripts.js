...
(function($) {
    ...
    const phrases = ["Data-driven professional turning insights into action.", "Curious learner on a journey of exploring.", "Fitness enthusiast sculpting both body and mind."];
    let currentIndex = 0;
    let currentPhrase = "";
    let charIndex = 0;
